...
// Clamp pixel ratio based on device capabilities to reduce GPU load on weak devices
...
const defaultHeartImages = [
  'images/467553417_9682041685145899_5913102194453311894_n.jpg',
  'images/487303083_9866396553380796_1278908609674399581_n.jpg',
  'images/490302179_10223259833204658_9046903945556901717_n.jpg',
  'images/502466435_4002525809959361_132134586158313960_n.jpg',
  'images/509432337_10237871117225490_6164059377067214416_n.jpg',
  'images/515511350_3121959117970137_8293051602335550308_n.jpg',
  'images/516244707_24355089670751577_7867137602958808237_n.jpg',
  'images/518937961_24461609540099589_7815768882643924326_n.jpg',
  'images/525396751_10224552906210675_4661638607959139099_n.jpg',
  'images/525736939_23973090782362862_8634625294341909932_n.jpg',
  'images/525816812_4061034117441863_6761795551764550767_n.jpg',
  'images/526426604_4061033707441904_1615318986251241555_n.jpg',
  'images/571208480_2017664705719137_4476726025905811626_n.jpg',
  'images/571338796_10163396906629183_301635165271855680_n.jpg',
  'images/571629670_10163396907269183_236050159765845567_n.jpg',
  'images/579713368_10163432799664183_8026411644267368605_n.jpg',
  'images/Bản sao của Cô Cẩm Tú.jpg',
  'images/Bản sao của Cô Giang Huyền.jpg',
  'images/Bản sao của Cô Huế.jpg',
  'images/Bản sao của Cô Hải.jpg',
  'images/Bản sao của Cô Thuỳ Anh.jpg',
  'images/Bản sao của Cô Thuỳ Linh.png',
  'images/Bản sao của Cô Triệu Thu Hương.jpg',
  'images/Bản sao của Cô Điệp.jpg',
  'images/IMG_2296.JPG',
  'images/IMG_2297.JPG',
  'images/IMG_2299.JPG',
  'images/IMG_2300.JPG',
  'images/IMG_2301.PNG',
  'images/thumb_20240108_an_phu_o_ng_die_p.jpg',
  'images/thumb_20240108_chu_thi_ho_ng_ha_i.jpg',
  'images/thumb_20240108_chu_va_n_huy.jpg',
  'images/thumb_20240108_dinh_tro_ng_hie_u.jpg',
  'images/thumb_20240108_giang_thi_thu_huye_n.jpg',
  'images/thumb_20240108_le_ca_m_tu_.jpg',
  'images/thumb_20240108_le_quy_tai.jpg',
  'images/thumb_20240108_le_thi_ho_ng_nhung.jpg',
  'images/thumb_20240108_le_va_n_hu_ng.jpg',
  'images/thumb_20240108_ngo_thuy_linh.jpg',
  'images/thumb_20240108_nguye_n_du_o_ng_hu_ng.jpg',
  'images/thumb_20240108_nguye_n_phan_tinh.jpg',
  'images/thumb_20240108_nguye_n_thanh_thuy_.jpg',
  'images/thumb_20240108_nguye_n_thi_thu_trang.jpg',
  'images/thumb_20240108_nguye_n_thi_ye_n.jpg',
  'images/thumb_20240108_nguye_n_va_n_phong.jpg',
  'images/thumb_20240108_phan_thanh_du_c.jpg',
  'images/thumb_20240108_tra_n_thi_hue_.jpg',
  'images/thumb_20240108_trie_u_thu_hu_o_ng.jpg',
  'images/thumb_20240108_vu_tro_ng_sinh.jpg',
  'images/thumb_20250408_thanh_nt.png'
];
...
for (let group = 0; group < numGroups; group++) {
  ...
  // Precompute bounding spheres so we can make cheap distance checks per-group later
  if (groupGeometryNear.computeBoundingSphere) groupGeometryNear.computeBoundingSphere();
  if (groupGeometryFar.computeBoundingSphere) groupGeometryFar.computeBoundingSphere();
...
function createShootingStar() {
  ...
  // Đầu sao băng
  // Use lower-detail sphere for performance on weaker devices
...
function animate() {
  ...
  // Faster material switching for points groups: check distance to group's bounding sphere center
  scene.traverse(obj => {
    if (obj.isPoints && obj.userData.materialNear && obj.userData.materialFar) {
      // Use object's world position as center (we translated geometries when creating groups)
      const worldCenter = new THREE.Vector3();
      obj.getWorldPosition(worldCenter);

      // Ensure a bounding sphere exists (precomputed when creating group geometries)
      const geom = obj.geometry;
      if (geom && geom.boundingSphere === undefined && geom.computeBoundingSphere) {
        geom.computeBoundingSphere();
      }
      const bs = geom && geom.boundingSphere ? geom.boundingSphere.radius * obj.scale.x : 20;

      const distance = camera.position.distanceTo(worldCenter);
      const threshold = bs + 30; // tweakable threshold
...
// Debounced resize handler to avoid repeated expensive renderer updates
...
window.addEventListener('resize', () => {
  ...
  _resizeTimer = setTimeout(() => {
    ...
    renderer.setSize(window.innerWidth, window.innerHeight);
    // Adjust pixel ratio if device changed orientation / capabilities
    if (cpuCores <= 2 || isMobile) {
      renderer.setPixelRatio(1);
    } else {
      renderer.setPixelRatio(Math.min(window.devicePixelRatio, 2));
